...
("normal_tumour_distance", lambda t, n, r: (t[5][3] / t[5][0]) / ((n[5][3] / n[5][0]) + 0.00001)),



("normal_tumour_ref_depth", lambda t, n, r: ((t[r[0] + 1][0] / t[5][0]) + 0.00001) / ((n[r[0] + 1][0] / n[5][0]) + 0.00001)),
("normal_tumour_ref_mapq", lambda t, n, r: ((t[r[0] + 1][2] / (t[r[0]+1][0]+ 0.00001)) + 0.00001) / ((n[r[0] + 1][2] / (n[r[0]+1][0]+ 0.00001)) + 0.00001)),
("normal_tumour_ref_quality", lambda t, n, r: ((t[r[0] + 1][1] / (t[r[0]+1][0]+ 0.00001)) + 0.00001) / ((n[r[0] + 1][1] / (n[r[0]+1][0]+ 0.00001)) + 0.00001)),
("normal_tumour_ref_distance", lambda t, n, r: ((t[r[0] + 1][3] / (t[r[0]+1][0]+ 0.00001)) + 0.00001) / ((n[r[0] + 1][3] / (n[r[0]+1][0]+ 0.00001)) + 0.00001)),        
...
("tumour_variant_quality", lambda t, n, r: (t[5][1] - t[r[0] + 1][1])/t[5][0]),
("normal_variant_quality", lambda t, n, r: (n[5][1] - n[r[0] + 1][1])/n[5][0]),
